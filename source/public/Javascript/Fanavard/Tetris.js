...
//                     if (isBottomMove) {
//
//                         TetrisGame.matrix.setCharacter(moveTo.row-1,moveTo.column,charBlock.char);
...
//             TetrisGame.matrix.checkWords(TetrisGame.initValues.choosedWords,lastChar.row,lastChar.col,checkTypes,callBack);
//
